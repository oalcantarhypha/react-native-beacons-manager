...
export type BeaconsManagerANDROID = {
  ...
  startForegroundService: ( notifData: NotificationData, resolve: () => any, reject: () => any) => void,
  ...
  setEnableScheduledScanJobs: (enableScanJobs: boolean) => void,
  setBackgroundMode: (newMode: boolean) => void,
