...
function startForegroundService(notifData: NotificationData) {
  return new Promise((resolve, reject) => {
    BeaconsManager.startForegroundService(notifData, resolve, reject);
  });
}
...
function setDebug(debug: boolean): void { 
  BeaconsManager.setDebug(debug);
}

function setEnableScheduledScanJobs(enableScanJobs: boolean): void { 
  BeaconsManager.setEnableScheduledScanJobs(enableScanJobs);
}

function setBackgroundMode(newMode: boolean): void {
  BeaconsManager.setBackgroundMode(newMode);
}
